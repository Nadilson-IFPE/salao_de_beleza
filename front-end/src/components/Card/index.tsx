        ...
        <>
            <div className={style.background}>
                ...
                <div className={style.icons}>
                    <AiOutlineEdit color="#5F68B1" size={17} onClick={() => isAfterDate && handleChangeModal()} />
                    <RiDeleteBinLine color="#EB2E2E" size={17} onClick={() => isAfterDate && handleDelete()} />
                </div>
            </div>
            <ModalEdit isOpen={openModal} handleChangeModal={handleChangeModal} hour={String(hour)} name={name} id={id} />
        </>
    )
}