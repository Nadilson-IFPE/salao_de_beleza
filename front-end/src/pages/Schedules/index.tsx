...
export function Schedules() {
    const schema = yup.object().shape({
        phone: yup.string().required('Campo de telefone é obrigatório!'),
        name: yup.string().required('Campo de nome é obrigatório!'),
        date: yup.string().required('Campo de data é obrigatório!'),
        hour: yup.string().required('Campo de hora é obrigatório!'),
    });
    const {
        register,
        handleSubmit,
